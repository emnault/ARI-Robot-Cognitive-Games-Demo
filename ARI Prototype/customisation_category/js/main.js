  ...
  //   }
    ...
    async firstFrase() {
        ...
        this.tts_action.sendGoal({
            rawtext: {
                text: "<mark name='doTrick trickName=alive_2'/> This part allows you to customise the activity. For the category checker task, <mark name='doTrick trickName=alive_1'/>you can choose how you would like the categories to be displayed. For the sake of this demonstration we will use the image with text option.", 
                lang_id: "en_GB"
            }
        }, (response) => {
